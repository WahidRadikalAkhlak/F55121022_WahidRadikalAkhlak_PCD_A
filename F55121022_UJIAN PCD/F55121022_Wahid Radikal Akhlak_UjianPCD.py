...
def show_creator():
    creator_label = tk.Label(root, text='Nama : Wahid Radikal Akhlak   | NIM : F55121022   | Kelas : A  | Jurusan : Teknologi Informasi | Prodi : Teknik Informatika')
    creator_label.place(x=160, y=480)
